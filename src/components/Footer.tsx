        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-16">
          ...
          <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <a href="mailto:founders@probound.ai" className="text-gray-400 hover:text-white">founders@probound.ai</a>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col space-y-2">
                <a href="https://docs.google.com/document/d/1mO6CnCVbuScd1eRn83CNRYO8ldPJ18PlX5XAF0M8xq4/edit?usp=sharing" 
                   className="text-gray-400 hover:text-white">Privacy Policy</a>
                <a href="https://docs.google.com/document/d/1mO6CnCVbuScd1eRn83CNRYO8ldPJ18PlX5XAF0M8xq4/edit?usp=sharing" 
                   className="text-gray-400 hover:text-white">Data Policy</a>
                <a href="https://docs.google.com/document/d/1mO6CnCVbuScd1eRn83CNRYO8ldPJ18PlX5XAF0M8xq4/edit?usp=sharing" 
                   className="text-gray-400 hover:text-white">Terms & Conditions</a>
              </div>
            </div>
          </div>
        </div>
