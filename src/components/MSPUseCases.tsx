  ...
  return <section className="py-16 sm:py-24 bg-muted/20">
      <div className="container px-4">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Built for IT Scenarios</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          {useCases.map((useCase, index) => <div key={index} className="group bg-card rounded-xl p-4 sm:p-6 lg:p-8 border border-border/40 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300">
